                                            ...
                                            err => {
                                                if (err) {
                                                    ...
                                                    if (ftpUpload) {
                                                        let ftp = new jsftp(
                                                            jsftpDetails
                                                        ); // need to create a new FTP connection for each file hence it being inside the watch function
                                                                            ...
                                                                            notifier.notify(
                                                                                {
                                                                                    title:
                                                                                        "FTP Error",
                                                                                    message:
                                                                                        "Cannot connect to the server. Please make sure the FTP Username and Password are correct."
                                                                                }
                                                                            );
                                                                        } else {
                                                                            console.log(
                                                                                "assets/css/screen.css - uploaded successfuly"
                                                                            );
                                                                            ...
                                                                            notifier.notify(
                                                                                {
                                                                                    title:
                                                                                        "Success!",
                                                                                    message:
                                                                                        "Successfully uploaded assets/css/screen.css"
                                                                                }
                                                                            );
                                ...
                                ftp.put(
                                    ...
                                    putError => {
                                        if (putError) {
                                            ...
                                            console.log(
                                                "assets/css/screen.css.map - uploaded successfuly"
                                            );
